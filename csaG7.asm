...
return db 10, 13, "          Press any key back to member menu...$"
...
Member proc
    ...
    int 21h
    cmp al, 31h
    je RegisterMember    ; jump out of range
    cmp al, 32h
    je DisplayMember  
    cmp al, 33h
    je ExitMember
